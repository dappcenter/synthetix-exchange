						...
						Header: (
							<FlexDivCentered>
								...
								<StyledTooltip
									...
									title={
										<div>
											<div>What is fee reclamation</div>
											<div>Rebate: means this</div>
											<div>Reclaim: means this</div>
										</div>
									}
									placement="top"
									arrow={true}
						...
						Cell: (cellProps: CellProps<HistoricalTrade, HistoricalTrade['isSettled']>) => {
							...
							return cellProps.cell.value ? (
								<FeeReclaim isRebate={isRebate}>
									...
									>
										<span>
											{formatCurrencyWithKey(toCurrencyKey, amount, SHORT_CRYPTO_CURRENCY_DECIMALS)}
										</span>
									</Tooltip>
								</FeeReclaim>
							) : (
